package ConnectedToStronglyConnected;
// Java program for making connected undirected graph to strongly connected directed graph
import java.util.*;
...
static void convert(ArrayList<ArrayList<Integer>> adj,int n)
{
